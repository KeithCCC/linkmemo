...
| ステップ     | 機能名                 | 効果                   |
| -------- | ------------------- | -------------------- |
| ✅ Step 1 | `[[リンク]]`→ちゃんとリンク動作 | リンク活用の土台を完成させる       |
| ✅ Step 2 | バックリンク一覧の強化         | 思考の“参照元”発見がしやすくなる    |
| ⬜ Step 3 | タグクリックでフィルター        | 思考の分類・抽出が一気にしやすく     |
| ⬜ Step 4 | 関連ノート（自動提案）         | ZKの“自己発展”性をサポート      |
| ⬜ Step 5 | グラフビュー導入            | ノート全体の地図を視覚で理解できるように |
| ⬜ Step 6 | 永続ID、ノート種別、テンプレ導入   | 本格的ZK道場モードへ！         |
